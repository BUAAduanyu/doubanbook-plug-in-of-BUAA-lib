// ==UserScript==
// @name          北京航空航天大学图书馆豆瓣读书及荐购插件
// @namespace     http://www.buaalib.com/normal/index.aspx
// @description   豆瓣读书页面中显示我航图书馆借阅信息，在检索到没有相关图书时，通过点击“荐书”即可完成荐书。————北航，宇航，段毓||修改。 
// @version	      1.2
...
// lib search url
var url_lib = 'http://202.112.134.140:8080/opac/';
var url_search = 'http://202.112.134.140:8080/opac/openlink.php?strText=' + book_title + '&strSearchType=title';
var url_isbn_search = 'http://202.112.134.140:8080/opac/openlink.php?strText=' + isbn + '&strSearchType=isbn';


var html_title = '<div class="da3" style="margin-bottom:0px;padding-bottom:1px;"><img src="http://www.buaa.edu.cn/favicon.ico" width="15px;" height="15px;" style="margin-bottom:-2px;" /><b><a href="http://www.buaalib.com/normal/index.aspx" target="_blank" style="font-size:medium">北京航空航天大学图书馆</a></b></div>';

var html_recommend_title = '<div class="da3" style="margin-bottom:0px;padding-bottom:1px;"><img src="http://www.buaa.edu.cn/favicon.ico" width="15px;" height="15px;" style="margin-bottom:-2px;" /><b><a href="http://www.buaalib.com/normal/index.aspx" target="_blank" style="font-size:medium">北京航空航天大学图书馆</a></b></div>';
...
var html_body_endmore = '<div style="text-align:right; padding:5px 10px 5px 0px;"><a href="http://202.112.134.140:8080/opac/openlink.php?strText=' +     book_title + '&strSearchType=title" target="_blank">更多&hellip;</a></div>';
...
GM_xmlhttpRequest({
    ...
    onload: function(responseDetails) {
    	...
    	var url_recommend = 'http://202.112.134.140:8080/asord/asord_redr.php?click_type=commit&title=' + keyword1 + '&a_name=' + author +'%8B&b_pub=' + pub + '&b_date=' + date + '&b_type='+ type + '&b_isbn=' + isbn;
